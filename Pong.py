# Simple pong in Python 3 (Pycharm 2018.2)
# By Sandeepthirumurthi
# 18/11/2020     4:15pm
# Ref : "Youtube" - freeCodeCamp
...
wn = turtle.Screen()
wn.title("Pong by Sandeepthirumurthi")
wn.bgcolor("black")
...
### Note : Avoid CAPITAL LETTER inside "" . ###
